import type { MessageContentBlock, AttachmentPayload, UserContentBlock } from "./types";
...
// ---------------------------------------------------------------------------
// Symmetric codec: build user content for SDK input
// (paired with parseUserFacingContent above)
// ---------------------------------------------------------------------------
