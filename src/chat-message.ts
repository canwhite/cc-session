...
// Re-export buildUserMessageContent so existing callers don't need to change imports.
// The implementation lives in message-parsing.ts alongside its symmetric counterpart
// parseUserFacingContent.
export { buildUserMessageContent } from "./message-parsing";
